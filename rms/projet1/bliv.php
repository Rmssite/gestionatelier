            ...
            <div class="figure w-50 mt-0 mb-3 px-2 border border-1 border-warning text-center ">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6  text-start mt-5  ">
                        <button type="submit" name="btnaddbl" class="btn btn-primary my-1 " data-bs-placement="bottom" title="Modifier les donnees" value="envoyer">Ajouter</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    ?>
                        ...
                        <td>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="<?php echo @$eng['numjob']?>" name="chkaddbl[]" id="defaultCheck1">
