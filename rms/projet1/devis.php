<?php
   ...
   @$cheminfichier=$_SESSION['cheminfichier'];
            ...
            <div class="figure w-75 mt-0 mb-3 px-2 border border-1 border-warning text-center ">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6  text-start mt-5  ">
                        <button type="submit" name="btnaddev" class="btn btn-primary my-1 " data-bs-placement="bottom" title="Modifier les donnees" value="envoyer">Ajouter</button>
                    </div>
